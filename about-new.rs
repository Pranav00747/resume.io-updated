   ...
   if(its_my_life=="It's off limits right now")
{
   ...
   let also_add : string = "And IDE Coder Runner with LLMs i will take less time for it minimum 7 days/week  because i can code quickly it's done by single person not by a Developers Team in company or a group of friends in university project basically created in groups credit goes to that things and i will start it after settlement,"; 
